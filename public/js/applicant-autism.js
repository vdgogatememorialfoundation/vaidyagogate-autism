...
window.deleteCompetitionSubmission = async function(id) {
    ...
    function renderCompTrackCard(r) {
        ...
        foot +=
            ...
            '<button type="button" onclick="deleteCompetitionSubmission(' + r.id + ')" class="btn-primary" style="position:absolute;top:0;right:0;background:#fee2e2;color:#b91c1c;padding:6px 12px;font-size:0.75rem;"><i class="fas fa-trash"></i> Delete</button>' +
            '<img src="/api/qrcode/' +
