...
(function () {
    ...
    function renderCompTrackCard(r) {
        ...
        foot +=
            ...
            '<button type="button" onclick="downloadCompetitionCertificate(\'' + encodeURIComponent(JSON.stringify(r)) + '\')" class="btn-primary" style="background:#0f766e;padding:6px 12px;font-size:0.75rem;"><i class="fas fa-award"></i> Certificate</button>' +
            '<button type="button" onclick="deleteCompetitionSubmission(' + r.id + ')" class="btn-primary" style="background:#fee2e2;color:#b91c1c;padding:6px 12px;font-size:0.75rem;"><i class="fas fa-trash"></i> Delete</button>' +
            '</div>' +
            '<img src="/api/qrcode/' +
