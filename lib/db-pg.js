...
function runQuery(sql, params, callback, ctx) {
    ...
    if (isInsert) {
        console.log('[pg-runQuery] INSERT SQL:', sql.substring(0, 100));
        console.log('[pg-runQuery] Final SQL:', pgSql.substring(0, 150));
        console.log('[pg-runQuery] addReturning:', addReturning);
    }
