...
function publicDatabaseHint(code) {
    switch (code) {
        ...
        case 'DATABASE_URL_HOST_INVALID':
            return 'Neon Console → your project → Connect → copy “Pooled connection” (host must include region, e.g. us-east-2.aws.neon.tech). Replace DATABASE_URL in Vercel entirely, then Redeploy. Do not use “....” from docs.';
