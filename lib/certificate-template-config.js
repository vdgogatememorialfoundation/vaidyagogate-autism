 ...
 * {{competition_title}}, {{competition_category}} (competition certificates)
 */
...
const DEFAULT_CONFIG = {
    ...
    bodyCompetition:
        'For participating in the <strong>{{competition_category}}</strong> competition at <strong>{{seminar_title}}</strong> hosted by the Vaidya Gogate Memorial Foundation',
    venueLabel: 'Venue',
    dateLabel: 'Date',
    venueOverride: '',
    dateOverride: '',
...
const AUTISM_DEFAULT_CONFIG = {
    ...
    bodyCompetition:
        'For the creative entry &ldquo;<em>{{competition_title}}</em>&rdquo; in the <strong>{{competition_category}}</strong> competition at <strong>{{seminar_title}}</strong>',
    venueLabel: 'Venue',
    dateLabel: 'Date',
    venueOverride: '',
    dateOverride: '',
