...
const GATEWAY_DESCRIPTIONS = {
    razorpay:
        'Razorpay Checkout — card, UPI apps, netbanking. Opens hosted checkout; applicant can also pay from their portal.',
...
function buildAdminPaymentMethods(rows, upiCfg) {
    ...
    methods.push({
        ...
        description: rz
            ? 'Creates a one-time Razorpay UPI QR for the exact fee. Status updates automatically when payment is received; the applicant sees the order and e-ticket in their dashboard.'
            : hasUpi
            ...
            if (mid === 'cash') {
                return fulfillRegistrationPayment(
                    ...
                    (fErr, meta) => {
                        ...
                        finishInit({
                            paid: true,
                            message: 'Cash payment recorded. E-ticket issued on the applicant dashboard.',
                            gateway: 'cash',
            ...
            if (mid === 'mock') {
                return fulfillRegistrationPayment(
                    ...
                    (fErr, meta) => {
                        ...
                        finishInit({
                            paid: true,
                            message: 'Test payment recorded. Applicant dashboard updated.',
                            gateway: 'mock'
                        });
                    }
                );
                                ...
                                db.run(
                                    ...
                                    (uErr) => {
                                        ...
                                        finishInit({
                                            ...
                                            pollRequired: true,
                                            message:
                                                'DQR created. Ask the applicant to scan the QR; payment will confirm automatically.'
                                        });
                                    }
                                );
                            }
                            ...
                            db.run(
                                ...
                                (uErr) => {
                                    ...
                                    finishInit({
                                        ...
                                        pollRequired: true,
                                        message: 'Razorpay checkout ready. Complete payment in the popup or applicant portal.'
                                    });
                                }
                            );
                        }
                        ...
                        (fErr, meta) => {
                            ...
                            cb(null, {
                                ...
                                message:
                                    ...
                                    ' payment received. Applicant dashboard updated.'
                            });
                        }
                    );
                }
        ...
        (err, row) => {
            ...
            if (row.status === 'success') {
                return cb(null, {
                    paid: true,
                    status: 'success',
                    message: 'Already paid — visible in applicant dashboard.'
                });
            }
                        ...
                        fulfillRegistrationPayment(
                            ...
                            (fErr, meta) => {
                                ...
                                cb(null, {
                                    ...
                                    status: 'success',
                                    ticketId: meta && meta.ticketId,
                                    message: 'Payment received. Applicant dashboard updated.'
                                });
                            }
                        );
                    });
                        ...
                        fulfillRegistrationPayment(
                            ...
                            (fErr, meta) => {
                                ...
                                cb(null, {
                                    paid: true,
                                    status: 'success',
                                    message: 'Razorpay payment captured. Applicant dashboard updated.'
                                });
                            }
                        );
                    });
        ...
        (err, row) => {
            ...
            fulfillRegistrationPayment(
                ...
                (fErr, meta) => {
                    ...
                    cb(null, {
                        paid: true,
                        message: 'Payment recorded. Applicant dashboard updated.',
                        ticketId: meta && meta.ticketId
                    });
                }
            );
