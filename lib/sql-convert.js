...
function convertSqliteToPostgres(sql) {
    ...
    s = s.replace(/\bexpires_at\s*>\s*\?/gi, 'expires_at::timestamptz > ?::timestamptz');
    s = s.replace(/\bcreated_at\s*>\s*\?/gi, 'created_at::timestamptz > ?::timestamptz');
...
const INSERT_TABLES_WITHOUT_ID = /\bINTO\s+(global_settings|pages|registration_reminder_log|file_blobs|otp_whatsapp_deliveries)\b/i;
