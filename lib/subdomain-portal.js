...
function pathPortalMiddleware(req, res, next) {
    ...
    if (pathname === '/live-checkin' || pathname === '/admin-live-scanner') return send('admin-live-scanner.html');
    if (pathname === '/admin-live-scanner.html') return res.redirect(302, '/live-checkin');
