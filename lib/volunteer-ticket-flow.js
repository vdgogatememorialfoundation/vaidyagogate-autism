        ...
        loadRegistration(db, uid, sid, regIdParam, (eReg, reg) => {
            ...
            if (!isRegistrationCompleteForVolunteer(reg)) {
                return cb(null, {
                    ...
                    message: 'Applicant must complete seminar registration before a free volunteer ticket can be issued.'
                });
            }
                                                        ...
                                                        volunteerCertFlow.autoIssueDualVolunteerCertificates(
                                                            ...
                                                            (certErr) => {
                                                                ...
                                                                cb(null, {
                                                                    ...
                                                                    registrationId: reg.id,
                                                                    message:
                                                                        'Volunteer registration complete. Free e-ticket (₹0) and certificates are ready in the applicant portal.'
                                                                });
                                                            }
                                                        );
                                                    }
