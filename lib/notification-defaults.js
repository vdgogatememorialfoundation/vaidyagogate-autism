...
const DEFAULT_TEMPLATES = [
    ...
    },
    {
        ...
        channel: 'both',
        email_subject: 'Welcome to {{portal_title}}',
        email_html: wrapHtml(
            'Account created',
            '<p>Dear {{full_name}},</p><p>Your account has been successfully created on the {{portal_title}}.</p><p><strong>Your Login Details:</strong><br>User ID: {{user_id_string}}<br>Registered Email: {{email}}<br>Password: {{temporary_password}}</p>' +
                '<p>You can now log in and register for events, submit applications, and manage your profile.</p>' +
