...
const APPS = [
    ...
    { dir: 'doctor-mobile', url: `${AUTISM}/dashboard?app=1&authv=7`, title: 'Autism Applicant', hostname: 'autism.vaidyagogate.org', allow: [AUTISM, 'https://autism-flax.vercel.app'], appId: 'org.vaidyagogate.autism.applicant' },
    {
        dir: 'scanner-mobile',
